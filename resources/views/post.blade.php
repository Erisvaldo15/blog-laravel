...
@section('content')
            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <div class="mainheading">
                    ...
                    <div class="row post-top-meta">
                        ...
                        <div class="col-md-10">
                            <a class="link-dark"
                                href="{{ route('author', $post->user->id) }}">{{ $post->user->full_name }}</a><a
                            ...
                            <span class="post-date">22 July 2017</span><span class="dot"></span><span class="post-read">6
                                min read</span>
                        </div>
                    </div>
                    <!-- End Top Menta -->
                ...
                <div class="article-post">
                    <p>
                        Holy grail funding non-disclosure agreement advisor ramen bootstrapping ecosystem. Beta crowdfunding
                        iteration assets business plan paradigm shift stealth mass market seed money rockstar niche market
                        marketing buzz market.
                    </p>
                    <p>
                        Burn rate release facebook termsheet equity technology. Interaction design rockstar network effects
                        handshake creative startup direct mailing. Technology influencer direct mailing deployment return on
                        investment seed round.
                    </p>
                    <p>
                        Termsheet business model canvas user experience churn rate low hanging fruit backing iteration buyer
                        seed money. Virality release launch party channels validation learning curve paradigm shift
                        hypotheses conversion. Stealth leverage freemium venture startup business-to-business accelerator
                        market.
                    </p>
                    <blockquote>
                        Gen-z strategy long tail churn rate seed money channels user experience incubator startup partner
                        network low hanging fruit direct mailing. Client backing success startup assets responsive web
                        design burn rate A/B testing metrics first mover advantage conversion.
                    </blockquote>
                    <p>
    ...
    <div id="comments" class="d-flex flex-column align-items-center">
        <h4> Comments ({{ $post->user->comments->count() }}) </h4>
        @forelse ($post->user->comments as $comment)
            <div id="comment-container" class="d-flex w-75 mt-4">
                <div id="photo">
                    <img class="img-fluid img-thumb" src="assets/img/demopic/7.jpg" alt="">
                </div>
                <div id="comment">
                    <h5> 
                        <a href="/author/{{$comment->user->firstName}}"> {{ $comment->user->firstName }}  </a>
                    </h5>
                    <p> {{ $comment->comment }} </p>
                    <b> Replay </b>
                </div>
