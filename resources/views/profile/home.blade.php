    ...
    <div class="bg-white py-12">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-lg font-semibold text-orange-600">Managers account</h2>
            ...
            <div class="mt-10">
                <dl class="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
                    <div class="relative ">
                        <dt>
                            <div
                                class="absolute flex h-12 w-12 items-center justify-center rounded-md bg-orange-500 text-white">
                            ...
                            <a href="" class="hover:text-orange-500 ml-16 text-lg font-medium leading-6 text-gray-900">
                                Add new posts
                            </a>
                        </dt>
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <a href="" class="hover:text-orange-500 ml-16 text-lg font-medium leading-6 text-gray-900">Delete your posts</a>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing
                            elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</dd>
                    </div>
