...
@section('content')
    <div class="overflow-hidden bg-white shadow sm:rounded-lg py-5 px-10">
                        ...
                        <ul role="list" class="divide-y divide-gray-200 rounded-md border border-gray-200">
                            <li class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                ...
                                <div class="ml-4 flex-shrink-0">
                                    <a href="{{ route('profile.update', $user->id) }}" class="font-medium text-orange-500 hover:text-orange-900">Change</a>
                                </div>
                            </li>
                        </ul>
                    </dd>
